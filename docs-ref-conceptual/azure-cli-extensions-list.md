...
| [aks-preview](https://github.com/Azure/azure-cli-extensions/tree/master/src/aks-preview) | 0.4.19 | 예정된 AKS 기능에 대한 미리 보기 제공 | 예 |
...
| [azure-cli-iot-ext](https://github.com/azure/azure-iot-cli-extension) | 0.8.5 | Azure IoT Hub, IoT Edge 및 IoT 디바이스 프로비전 서비스에 대한 데이터 플레인 명령 계층 제공 |  |
| [azure-cli-ml](https://docs.microsoft.com/azure/machine-learning/service/) | 1.0.72 | Microsoft Azure 명령줄 도구 AzureML 명령 모듈 |  |
| [azure-devops](https://github.com/Microsoft/azure-devops-cli-extension) | 0.13.0 | Azure DevOps를 관리하는 도구입니다. |  |
| [azure-firewall](https://github.com/Azure/azure-cli-extensions/tree/master/src/azure-firewall) | 0.1.4 | Azure Firewall 리소스를 관리합니다. | 예 |
...
| [internet-analyzer](https://github.com/Azure/azure-cli-extensions) | 0.1.0rc2 | Microsoft Azure 명령줄 도구 Internet Analyzer 확장 | 예 |
...
| [virtual-wan](https://github.com/Azure/azure-cli-extensions/tree/master/src/virtual-wan) | 0.1.1 | 가상 WAN, 허브, VPN 게이트웨이 및 VPN 사이트를 관리합니다. | 예 |
