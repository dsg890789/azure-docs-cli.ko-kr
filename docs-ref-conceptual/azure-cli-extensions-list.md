...
| [keyvault-preview](https://github.com/Azure/azure-keyvault-cli-extension) | 0.1.2 | Azure Key Vault 미리보기 명령어 | 예 |
...
| [webapp](https://github.com/Azure/azure-cli-extensions) | 0.2.2 | 앱 서비스 리소스를 관리하는 Azure CLI Extension | 예 |
