...
| [db-up](https://github.com/Azure/azure-cli-extensions/tree/master/src/db-up) | 0.1.9 | Azure Database 워크플로를 간소화하는 추가 명령입니다. | 예 |
...
| [front-door](https://github.com/Azure/azure-cli-extensions/tree/master/src/front-door) | 0.1.2 | 네트워킹 Front Doors를 관리합니다. | 예 |
