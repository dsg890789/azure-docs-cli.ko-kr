...
| [aks-preview](https://github.com/Azure/azure-cli-extensions/tree/master/src/aks-preview) | 0.4.8 | 예정된 AKS 기능에 대한 미리 보기 제공 | 예 |
...
| [azure-cli-ml](https://docs.microsoft.com/en-us/azure/machine-learning/service/) | 1.0.55 | Microsoft Azure 명령줄 도구 AzureML 명령 모듈 |  |
